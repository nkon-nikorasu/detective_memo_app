class IncidentTime < ApplicationRecord
  ...
  validates :hour, numericality: { only_integer: true, greater_than_or_equal_to: 1, less_than_or_equal_to: 23, allow_nil: true }
  validates :minute, :second, numericality: { only_integer: true, greater_than_or_equal_to: 1, less_than_or_equal_to: 59, allow_nil: true }
